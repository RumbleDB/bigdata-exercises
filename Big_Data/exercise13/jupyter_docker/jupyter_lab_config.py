...
#  Default: False
# NOTE: We specifically disable this for security reasons.
...
#  Default: False
# NOTE: We add this so we can create new kernels through VS Code without issues.
...
#  Default: 0
# NOTE: We use JUPYTER_PORT env var externally
# c.ServerApp.port = 0
